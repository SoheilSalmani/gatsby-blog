...
* Offset only have a meaning for a specific partition. E.g. offset 3 in partition 0 doesn't represent the same data as offset 3 in parition 1.
...
* There are 3 delivery semantics:
  ...
  * *Exactly once:*
    ...
    * For Kafka &rArr; External System workflows, use an *idempotent* consumer.
