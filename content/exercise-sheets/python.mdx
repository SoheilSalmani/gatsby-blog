...
20. Configure Flake8, Darglint and xdoctest to check docstrings in the codebase.
...
21. Add docstrings in the Nox configuration file.
...
22. Check that your docstrings are showed when you list Nox sessions using the
    `nox` CLI.
...
23. Add docstrings in the `wikipedia-cli` package.
...
24. Add docstrings in the test suite.
...
25. Configure Sphinx to build a documentation.
